package com.example.mypet; //CD21062,CD21033,CD21068
...
public class mainmenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView calculatorCard = findViewById(R.id.calculator_card);
        CardView shakeCard = findViewById(R.id.shake_card);
        ...
        shakeCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mainmenu.this, Shake.class);
                startActivity(intent);
            }
        });
